...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    return {percentage >= 80: "green",  60 <= percentage < 80: "orange", 30 <= percentage < 60: "red"}.get(True, "black")
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    return {percentage < 0.9 * threshold: "LOW", threshold * 0.9 < percentage < threshold * 1.1: "NORMAL"}.get(True, "DANGER")
